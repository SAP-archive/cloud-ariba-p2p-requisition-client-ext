...
import ariba.buyer.vrealm_3.requisition.RequisitionRequisitionImportPull.DefaultLineItem;
import ariba.buyer.vrealm_3.requisition.RequisitionRequisitionImportPull.Preparer;
import ariba.buyer.vrealm_3.requisition.RequisitionRequisitionImportPull.Requester;
...
public final class RequisitionImportPullPortType_RequisitionImportPullPortType_Client {
	...
	private static RequisitionImportPullRequest prepareRequisition(PrepareRequisitionParameter parameterObject) throws DatatypeConfigurationException {
	    ...
	    _requisitionRequisitionImportPull.setOriginatingSystemReferenceID(_originatingSystemReferenceID);
	...
	private static RequisitionRequisitionImportPull.LineItems.Item prepareItem(PrepareItemParameter parameterObject) throws DatatypeConfigurationException {
	    ...
	    JAXBElement<BigDecimal> _descriptionPriceAmount = 
        		factory.createRequisitionRequisitionImportPullLineItemsItemDescriptionPriceAmount(new BigDecimal(parameterObject.itemPrice));
        ...
        JAXBElement<BigInteger> _numberInCollection = 
        		factory.createRequisitionRequisitionImportPullLineItemsItemNumberInCollection(BigInteger.valueOf(parameterObject.numberInCollection));
        _item.setNumberInCollection(_numberInCollection);
        JAXBElement<BigInteger> _originatingSystemLineNumber = 
        		factory.createRequisitionRequisitionImportPullLineItemsItemOriginatingSystemLineNumber(BigInteger.valueOf(parameterObject.originatingSystemLineNumber));
