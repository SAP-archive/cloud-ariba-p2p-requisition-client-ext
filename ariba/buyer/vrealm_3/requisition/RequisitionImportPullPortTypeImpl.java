...
public class RequisitionImportPullPortTypeImpl implements RequisitionImportPullPortType {
     ...
     */
    public ariba.buyer.vrealm_3.requisition.RequisitionImportPullReply requisitionImportPullOperation(RequisitionImportPullRequest body) { 
        LOG.info("Executing operation requisitionImportPullOperation");
        System.out.println(body);
        try {
            ariba.buyer.vrealm_3.requisition.RequisitionImportPullReply _return = null;
            return _return;
